...
package shapefileloader.statistic;
 ...
 * @author wb385924
 */
public class P_StatisticConfig implements P_Config{
    ...
    public boolean equals(Object obj) {
        ...
        final P_StatisticConfig other = (P_StatisticConfig) obj;
    ...
    private static final Logger log = Logger.getLogger(P_StatisticConfig.class.getName());
    ...
    public P_StatisticConfig() {
    }

    public P_StatisticConfig(stat_type statType, scenario scenario, climatestat stat, int fYear, int tYear, int percentile) {
        this.percentile = percentile;
        this.scenario = scenario;
        this.stat = stat;
        this.fYear = fYear;
    ...
    public gcm getGcm() {
        log.warning("should not be asking stat for gcm");
        return null;
    }

    public void setGcm(gcm gcm) {

        log.warning("should not setting gcm for statistic ");
    }
